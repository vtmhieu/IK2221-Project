...
// Addresses
define($VIP 100.0.0.45, $LB_MAC 12:12:12:12:12:12, $llm1 100.0.0.40, $llm2 100.0.0.41, $llm3 100.0.0.42)
...
arp_rest2::ARPResponder($VIP $LB_MAC, 100.0.0.1 $LB_MAC)
...
// FORWARD PATH: Checksum recalculation and backend routing
lb_rw[0] -> IPPrint("LB1: rewritten -> backend", TIMESTAMP true) 
         -> lb_fwd_csum :: IPClassifier(tcp, udp, -);
lb_fwd_csum[0] -> SetIPChecksum -> SetTCPChecksum -> llm_out;
lb_fwd_csum[1] -> SetIPChecksum -> SetUDPChecksum -> llm_out;
lb_fwd_csum[2] -> SetIPChecksum -> llm_out;
...
// icmp classifier for testing and benchmarking purposes
icmp_rw[0] -> IPPrint("LB1 ICMP: rewritten -> backend", TIMESTAMP true) -> SetIPChecksum -> llm_out_icmp
...
lb_ret_csum[1] -> SetIPChecksum -> SetUDPChecksum -> GetIPAddress(16) -> arpq_clients;
lb_ret_csum[2] -> SetIPChecksum -> GetIPAddress(16) -> arpq_clients;

icmp_rw[1] -> IPPrint("LB1 ICMP: rewritten -> client", TIMESTAMP true) 
           -> SetIPChecksum -> GetIPAddress(16) -> arpq_clients;
