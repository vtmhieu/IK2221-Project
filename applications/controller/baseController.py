...
class controller (object):
    ...
    def _handle_ConnectionUp(self, event):
        ...
        if(id<=3):
            ...
            self.devices[id] = click_wrapper.start_click("/opt/pox/ext/napt.click", "", "napt.report", "/tmp/napt.stderr")
        elif(id==5):
            ...
            self.devices[id] = click_wrapper.start_click("/opt/pox/ext/ids.click", "", "ids.report", "/tmp/ids.stderr")
        elif(id==6):
            ...
            self.devices[id] = click_wrapper.start_click("/opt/pox/ext/lb1.click", "", "lb1.report", "/tmp/lb1.stderr")
        else:
            # Error
